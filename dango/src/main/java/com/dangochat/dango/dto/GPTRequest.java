...
public class GPTRequest {
	...
	private int temperature;      //텍스트 생성의 랜덤성을 제거하는 값입니다. 값이 높을수록 결과가 더 다양해집니다.
	...
	public GPTRequest(String model, List<Message> previousMessages, // 이전 대화 내용을 포함하는 리스트
			String prompt, int temperature, int maxTokens, int topP, int frequencyPenalty, int presencePenalty) {
		this.model = model;
